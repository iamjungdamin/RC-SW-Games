...
def main():
    ...
    if index == 0:
        if timer == 1:
            canvas.create_text(300,150,text='타이틀',fill='white',font=fnt1,tag='TITLE')
        ...
        if key == 'space':
            ...
            canvas.create_text(300,150,text='게임 중',fill='white',font=fnt1,tag='GAME')
            canvas.create_text(300,300,text='[E] 종료',fill=('lime'),font=fnt2,tag='GAME')
            index = 1
            timer = 0
